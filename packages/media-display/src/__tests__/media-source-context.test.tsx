...
describe("MediaSourceContext", () => {
	...
	it("should have correct context type structure", () => {
		...
		expect(mockContextValue.data?.artworks).toHaveLength(1);
	...
	it("should support artworks array with Artwork objects", () => {
		...
		expect(contextValue.data?.artworks).toHaveLength(2);
		expect(contextValue.data?.artworks[0]).toMatchObject({
			id: "artwork-1",
			title: "Test Artwork 1",
			artist: "Test Artist 1",
		});
		expect(contextValue.data?.artworks[1]).toMatchObject({
			id: "artwork-2",
			title: "Test Artwork 2",
			artist: "Test Artist 2",
		});
	...
	it("should support minimal Artwork objects", () => {
		...
		expect(contextValue.data?.artworks[0].artist).toBeUndefined();
		expect(contextValue.data?.artworks[0].imageUrl).toBeUndefined();
		expect(contextValue.data?.artworks[0].description).toBeUndefined();
	});
	...
	it("should support empty artworks array", () => {
		...
		expect(emptyContextValue.data?.artworks).toHaveLength(0);
